    ...
    return (
        <div className='flex flex-col gap-3 rounded-2xl border border-surface-border bg-white p-4'>
            <div className='relative max-h-60 overflow-hidden'>
                <p className='font-text text-sm text-ink-secondary whitespace-pre-line'>
                    {application.generatedLetter}
                </p>
            ...
            <div className='flex items-center justify-between border-t border-surface-border pt-3'>
                ...
                <IconButton
                    ...
                    className={copied ? 'text-brand-green' : 'text-ink-secondary hover:text-ink'}
                />
            </div>
        </div>
    );
